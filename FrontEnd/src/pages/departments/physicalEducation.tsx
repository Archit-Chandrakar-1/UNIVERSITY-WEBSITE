// src/pages/departments/physicalEducationYoga.tsx
...
const SchoolOfPhysicalEducationYogaPage: React.FC = () => {
  const departmentFullName = "MATS SCHOOL OF PHYSICAL EDUCATION & YOGA";
  
  // Hardcoded description for now, as no dedicated description API is confirmed
  const descriptionText = "MATS School of Physical Education & Yoga empowers students in physical education, sports science, and yoga through rigorous academic programs, practical training, and holistic health approaches.";
...
export default SchoolOfPhysicalEducationYogaPage;
