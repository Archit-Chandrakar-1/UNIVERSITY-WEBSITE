// // src/pages/departments/LibrarySciences.tsx
...
const LibrarySciencesPage: React.FC = () => {
  const departmentFullName = "MATS School of Library Sciences";
  
  // Hardcoded description for now, as no dedicated description API is confirmed
  const descriptionText = "MATS School of Library Sciences provides advanced knowledge and practical expertise in information organization, management, and library science, preparing students for professional roles in academic, public, and digital libraries.";
...
export default LibrarySciencesPage;