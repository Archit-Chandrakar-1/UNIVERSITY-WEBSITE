// // src/pages/departments/schoolEducation.tsx
...
const SchoolOfEducationPage: React.FC = () => {
  const departmentFullName = "MATS SCHOOL OF EDUCATION";
  
  // Hardcoded description for now, as no dedicated description API is confirmed
  const descriptionText = "MATS School of Education provides comprehensive programs in teaching and educational theory, fostering effective educators and promoting research-driven advancements in the field of education.";
...
export default SchoolOfEducationPage;