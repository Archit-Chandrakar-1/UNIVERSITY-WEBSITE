// // src/pages/departments/InformationTechnology.tsx
...
const InformationTechnologyPage: React.FC = () => {
  const departmentFullName = "MATS SCHOOL OF INFORMATION TECHNOLOGY";
  
  // Hardcoded description for now, as no dedicated description API is confirmed
  const descriptionText = "MATS School of Information Technology fosters learning in computer science, animation, graphics design, and allied IT fields, with industry-focused programs designed to equip students for technology careers.";
