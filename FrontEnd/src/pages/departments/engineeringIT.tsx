// // src/pages/departments/engineeringIT.tsx
...
const EngineeringITPage: React.FC = () => {
  const departmentFullName = "MATS SCHOOL OF ENGINEERING & IT";
  
  // Hardcoded description for now, as no dedicated description API is confirmed
  const descriptionText = "MATS School of Engineering & IT offers cutting-edge programs in various engineering disciplines and information technology, fostering innovation, problem-solving skills, and industry readiness.";
...
export default EngineeringITPage;
