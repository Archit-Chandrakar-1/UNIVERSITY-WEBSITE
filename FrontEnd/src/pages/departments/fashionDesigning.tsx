// src/pages/departments/FashionDesigning.tsx
...
const FashionDesigningPage: React.FC = () => {
  const departmentFullName = "MATS SCHOOL OF FASHION DESIGNING & TECHNOLOGY";
  
  // Hardcoded description for now, as no dedicated description API is confirmed
  const descriptionText = "MATS School of Fashion Designing & Technology offers dynamic programs in Fashion and Interior Designing focused on creativity, technical skills, and industry readiness.";
...
export default FashionDesigningPage;