// src/pages/departments/schoolOfPharmacy.tsx
...
const SchoolOfPharmacyPage: React.FC = () => {
  const departmentFullName = "MATS SCHOOL OF PHARMACY";
  
  // Hardcoded description for now, as no dedicated description API is confirmed
  const descriptionText = "MATS School of Pharmacy prepares students for pharmaceutical careers through robust undergraduate and diploma programs, focusing on scientific fundamentals, practical training, and professional ethics.";
...
export default SchoolOfPharmacyPage;