// // src/pages/departments/LawSchool.tsx
...
const LawSchoolPage: React.FC = () => {
  const departmentFullName = "MATS LAW School";
  
  // Hardcoded description for now, as no dedicated description API is confirmed
  const descriptionText = "MATS School of Law offers undergraduate and postgraduate law programs that blend rigorous legal theory with practical experience. Our programs prepare students for diverse legal careers and leadership roles in society.";
